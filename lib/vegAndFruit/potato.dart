...
class Potato extends StatefulWidget {
  ...
  const Potato(this.recordName, {required String text});
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Chemicals: organic matter,phosphorous,calcium,potasium,magnisium,zinc,boron",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Description: Use Carbon disulphide 30 g/100 kg of seeds for breaking the dormancy and inducing sprouting of tubers.Initially water 2 times per day.Water 4 times per day and stop watering when the foliage begins to turn yellow and die off",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
