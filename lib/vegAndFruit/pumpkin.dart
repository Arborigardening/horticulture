...
class Pumpkin extends StatefulWidget {
  ...
  const Pumpkin(this.recordName, {required String text});
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Chemicals: balanced amount of nitrogen,phosphorous,potassium",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Sunshine:8 hrs/ day of direct sun",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
