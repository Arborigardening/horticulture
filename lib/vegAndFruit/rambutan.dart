...
class Rambutan extends StatefulWidget {
  ...
  const Rambutan(this.recordName, {required String text});

  // const PlantDetails({Key? key, required this.text}) : super(key: key)

  // @override
  @override
  State<Rambutan> createState() => _RambutanState();
}
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Chemicals: nitrogen,potassium,phosphorous,calcium,manganese",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Fertilizer: potash,urea,dried cow dung",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Description: medium-sized tropical tree in the family Sapindaceae. The name also refers to the edible fruit produced by this tree. The rambutan is native to Southeast Asia.[1] It is closely related to several other edible tropical fruits including the lychee, longan, pulasan and guinep.",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
