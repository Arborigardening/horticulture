...
class Snakegourd extends StatefulWidget {
  final String recordName;
  const Snakegourd(this.recordName, {required String text});

  // const PlantDetails({Key? key, required this.text}) : super(key: key)

  // @override
  @override
  State<Snakegourd> createState() => _SnakegourdState();
}

class _SnakegourdState extends State<Snakegourd> {
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Chemicals: low nitrogen,high potassium,high phosphorous",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Fertilizer: NPK:6-12-12,organic compost,neem cake",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
