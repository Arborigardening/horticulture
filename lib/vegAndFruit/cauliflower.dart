...
class Cauliflower extends StatefulWidget {
  ...
  const Cauliflower(this.recordName, {required String text});
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Chemicals: nitrogen,phosphorus,potash",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
                      ...
                      const Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                          "Description: Cauliflower is a sun-loving, cool-season crop to grow in spring and fall. An annual plant in the Brassica family, cauliflower’s edible white flesh is extremely healthy and considered a “superfood.”Cauliflower dislikes any interruption to its growth. Change, in the form of temperature, moisture, soil nutrition, or insects, can cause the plants to develop a head prematurely or ruin an existing one.",
                          style: const TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.w600,
                          ),
